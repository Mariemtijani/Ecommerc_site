...
if (!isset($_SESSION["login"])) {
    ...
    $allReq = $connexion -> prepare("SELECT * FROM produit ");
    $allReq -> execute();

    $phoneReq = $connexion -> prepare("SELECT * FROM produit WHERE id_cat=?");
    $phoneReq -> execute(array(18));
...
<body>
    ...
    <nav class="">
        ...
        <div class="navigation">
            ...
            <div class="personelle ">
               <a href="profil.php" class="text-muted mx-2 fw-bol">My profil</a>
               <a href="logOut.php"  class="text-muted mx-2 fw-bol">Log out</a>
            </div>
            ...
            <div class=" search_bar">
             ...
             <table class="col">
                ...
                <input type="hidden" name="hide" value="">
                    <td class="col"><input type="text" name="shir" id="inputsearch" placeholder="Search for products ...." class="form-control" style="width: 400px; margin-right:0px"></td>
                    <td class="col"><input type="submit" value="Search" id="search" style="display: none;" class="btn " ></td></tr>
             </table>
             </form>
        </div>
        ...
        <div class="menu">
            ...
            <a href="cart_shopping.php">
                <i class="fa-solid fa-cart-shopping fa-xl">
                    ...
                    <span class="num_product"><?php echo $nomber; ?></span>
                </i>
            </a>
   ...
   echo "none;";
    ...
    <ul id="cat">
        ...
        <li class="item" data-category="watch">
            <div class="categorie-box">
                <a href="#">
                    <i class="fa-solid  fa-clock fa-2xl" style=" color: #ef6817;"></i>
                </a>
            ...
            <div class=" product-box">
                ...
                <div class="product-img">
                    ...
                    <!--add to favorite------------->
                     ...
                     <form action="" method="post" id="formP1">

                        <input type="hidden" name="idPro" id="idPro" value="<?php echo $rowP -> id_pro?>">
                        <a  class="add-fav" onclick="favSubmit('formP1')"><i class="fa-solid fa-heart "></i></a>
                    </form>
        ...
        <div class="cat-content" data-category="laptob">
            ...
            <div class=" product-box">
                ...
                <div class="product-img">
                    ...
                    <!--add to favorite------------->
                     <form action="" method="post" id="formL1">

                        <input type="hidden" name="idPro" id="idPro" value="<?php echo $rowL -> id_pro?>">
                        <a  class="add-fav" onclick="favSubmit('formL1')"><i class="fa-solid fa-heart "></i></a>
                    </form>
        ...
        <div class="cat-content" data-category="tablet">
            ...
            <div class=" product-box">
                ...
                <div class="product-img">
                    ...
                    <!--add to favorite------------->
                   <form action="" method="post" id="formT1">

                        <input type="hidden" name="idPro" id="idPro" value="<?php echo $rowT -> id_pro?>">
                        <a  class="add-fav" onclick="favSubmit('formT1')"><i class="fa-solid fa-heart "></i></a>
                    </form>
        ...
        <div class="cat-content" data-category="watch">
            ...
            <div class=" product-box">
                ...
                <div class="product-img">
                    ...
                    <!--add to favorite------------->
                    <form action="" method="post" id="formW1">

                        <input type="hidden" name="idPro" id="idPro" value="<?php echo $rowW -> id_pro?>">
                        <a  class="add-fav" onclick="favSubmit('formW1')"><i class="fa-solid fa-heart "></i></a>
                    </form>
                ...
                <div class="product-img">
                    <!--add Cart------------->
                     <form action="" method="post" id="formH">
                        ...
                        <input type="hidden" name="idPro" id="idPro" value="<?php echo $rowH -> id_pro?>">
                        <a class="add-cart" onclick="submitForm('formH')">
                           <i class="fa-solid fa-cart-shopping "></i>
                        </a>
                    </form>
                    <!--add to favorite------------->
                    <form action="" method="post" id="formH1">

                        <input type="hidden" name="idPro" id="idPro" value="<?php echo $rowH -> id_pro?>">
                        <a  class="add-fav" onclick="favSubmit('formH1')"><i class="fa-solid fa-heart "></i></a>
                    </form>

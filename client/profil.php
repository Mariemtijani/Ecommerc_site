...
session_start();
    if (isset($_POST["ch"])) { 
        ...
        $re=$connexion->prepare("UPDATE client SET nom_client=?,prenom_client=?,adr_client=?,email=?,num_tele=? ");
...
<div class="d-flex justify-content-center container-fluid " style='margin-top:-50px;'>
    <div class="card col-8 " style="background-color: aliceblue; border-radius: 20px; margin-top: 100px;height: 710px;">
        <div class="nav justify-content-start" style="border-radius: 20px 20px 0px 0px; background: #ff5900;">
          <h3 class="d-flex flex-wrap align-content-center" style="margin-left: 30px;color: aliceblue; font-style: italic; height: 50px;"><?php echo  $bonjour ?><?php echo $l["nom_client"] ?> <?php echo $l["prenom_client"] ?>! <br></h4> 
!</h3>
</div>
        <div class="row" style="margin-left: 1px;">
            <div   style="border-radius: 0px px 0px 0px;background-color: rgb(255, 247, 247);height: 636px; width: 20.1%;"><br>
                ...
                <div style="margin-left: 7px;"><br>
                    <h5 id="nom" style="display: none;"><?php echo $l["nom_client"] ?> <?php echo $l["prenom_client"] ?></h5><br><br><br>
            ...
            <div style="margin-left: 107px;"><br>
              <div id='info'>
                ...
                <p class='font-monospace mt-2'><?php echo $l["user_name"] ?></p>
                <h5>Full name:</h5>
                <p class='font-monospace mt-2'><?php echo $l["nom_client"].' '.$l["prenom_client"]  ?></p>
                <h5>Address:</h5>
                <p class='font-monospace'><?php echo $l["adr_client"]  ?></p>
                <h5>Phone number:</h5>

...
<body >
  ...
  <center class='container mt-5'>
    ...
    <div class="carde" id="crd">
      ...
      <form action="loginrispoaction.php" method="post">
      <div class="col-7">  
        <input type="email" name="emaile" id="" class="col-6 mt-2  form-control" placeholder="Email_Adress " required></div>
      <div class="col-7">  
        <input type="password" name="passworde" id="" required class="mt-2 col form-control" placeholder="Password"></div>
